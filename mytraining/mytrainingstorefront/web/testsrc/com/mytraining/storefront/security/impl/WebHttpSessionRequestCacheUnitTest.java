...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/mytrainingstorefront/electronics/en",
						"https://electronics.local:9002/mytrainingstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/mytrainingstorefront/electronics/en",
						"https://electronics.local:9002/mytrainingstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/mytrainingstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/mytrainingstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/mytrainingstorefront/electronics/en",
						"https://electronics.local:9002/mytrainingstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/mytrainingstorefront",
						"https://electronics.local:9002/mytrainingstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/mytrainingstorefront",
						"https://electronics.local:9002/mytrainingstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/mytrainingstorefront/electronics/en",
						"https://electronics.local:9002/mytrainingstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
