 ...
 */
package com.mytraining.test.setup;
...
import com.mytraining.test.constants.MytrainingTestConstants;
import com.mytraining.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MytrainingTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/mytrainingtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/mytrainingtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/mytrainingtest/import/cstickets.impex");
			...
			importImpexFile(context, "/mytrainingtest/import/csquotes.impex");
		}
	}
}
