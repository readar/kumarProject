 ...
 */
package com.mytraining.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(MytrainingFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MytrainingFulfilmentProcessConstants.PARENT_PROCESS);
