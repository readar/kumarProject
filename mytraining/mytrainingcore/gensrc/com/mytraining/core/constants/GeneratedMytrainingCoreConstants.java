...
public class GeneratedMytrainingCoreConstants
{
	public static final String EXTENSIONNAME = "mytrainingcore";
	public static class TC
	{
		...
		public static final String MANOJCATEGORY = "ManojCategory".intern();
		public static final String MANOJPRODUCT = "ManojProduct".intern();
	...
	{
		public static final String MANOJPRODUCTMANOJCATEGORY = "ManojProductManojCategory".intern();
	}
	
	protected GeneratedMytrainingCoreConstants()
	{
		// private constructor
	}
