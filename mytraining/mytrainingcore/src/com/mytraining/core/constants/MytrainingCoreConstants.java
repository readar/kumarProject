...
/**
 * Global class for all MytrainingCore constants. You can add global constants for your extension into this class.
 */
public final class MytrainingCoreConstants extends GeneratedMytrainingCoreConstants
{
	public static final String EXTENSIONNAME = "mytrainingcore";


	private MytrainingCoreConstants()
	{
		//empty
	}
